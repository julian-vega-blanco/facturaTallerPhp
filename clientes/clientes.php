  ...
  <div class="contenedor">
    ...
    <div class="parte-media bg-info bg-gradient">
      <div style="display: flex; justify-content: space-between;">
        <h2>Clientes</h2>
        <button class="btn-m" data-bs-toggle="modal" data-bs-target="#registrarClientes"><i class="bi bi-person-add"></i></button>
      </div>
          ...
          <tbody class="" id="tabla">
            <?php foreach ($all as $val): ?>
              <tr>
                ...
                <td><a class="btn btn-danger" href="borrarCliente.php?id=<?= $val['Cliente_id']?>&req=delete">Borrar</a></td>
                <td><a class="btn btn-warning" href="editarCliente.php?id=<?= $val['Cliente_id']?>">Editar</a></td>
              </tr>
            <?php endforeach; ?>
          </tbody>
        </table>
    ...
    <div class="modal fade" id="registrarClientes" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" style="backdrop-filter: blur(5px)">
      <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        ...
        <input type="text" id="compañia" name="compañia" class="form-control" />
        </div>
