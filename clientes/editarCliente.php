...
if (isset($_POST["editar"])) {
    ...
    $data->update();
    echo "<script> alert('Se ingreso el usuario');document.location ='clientes.php'</script>";
}
?>
...
<body>
  <div class="contenedor">
    <div class="parte-izquierda">
      <div class="perfil">
        <h3 style="margin-bottom: 2rem;">Camp Clientes.</h3>
      ...
      <div class="menuTabla contenedor2">
        <form class="col d-flex flex-wrap" action="" method="post">
          ...
          <div class="mb-1 col-12">
            ...
            <input type="text" id="compañia" name="compañia" class="form-control" value="<?php echo $val['compañia']; ?>" />
          </div>
